...
const routes = [
  ...
  { path: '/admin/sasaran-iku-rpjmd', name: 'admin.sasaran-iku-rpjmd', component: page('admin/sasaran-iku-rpjmd/index'), meta: { label: 'Master Sasaran & IKU RPJMD' } },
  ...
  { path: '/admin/program', name: 'admin.program', component: page('admin/program/index'), meta: { label: 'Master Program' } },
  { path: '/admin/program/create', name: 'admin.program.create', component: page('admin/program/create'), meta: { label: 'Tambah Program', breadCrumbParent: {name: 'admin.program'} } },
  { path: '/admin/program/:id/edit', name: 'admin.program.edit', component: page('admin/program/edit'), meta: { label: 'Edit Program', breadCrumbParent: {name: 'admin.program'} } },
  { path: '/admin/kegiatan', name: 'admin.kegiatan', component: page('admin/kegiatan/index'), meta: { label: 'Master Kegiatan' } },
  { path: '/admin/kegiatan/create', name: 'admin.kegiatan.create', component: page('admin/kegiatan/create'), meta: { label: 'Tambah Kegiatan', breadCrumbParent: {name: 'admin.kegiatan'} } },
  { path: '/admin/kegiatan/:id/edit', name: 'admin.kegiatan.edit', component: page('admin/kegiatan/edit'), meta: { label: 'Edit Kegiatan', breadCrumbParent: {name: 'admin.kegiatan'} } },
  { path: '/admin/sub-kegiatan', name: 'admin.sub-kegiatan', component: page('admin/sub-kegiatan/index'), meta: { label: 'Master Sub Kegiatan' } },
  { path: '/admin/sub-kegiatan/create', name: 'admin.sub-kegiatan.create', component: page('admin/sub-kegiatan/create'), meta: { label: 'Tambah Sub Kegiatan', breadCrumbParent: {name: 'admin.sub-kegiatan'} } },
  { path: '/admin/sub-kegiatan/:id/edit', name: 'admin.sub-kegiatan.edit', component: page('admin/sub-kegiatan/edit'), meta: { label: 'Edit Sub Kegiatan', breadCrumbParent: {name: 'admin.sub-kegiatan'} } },
  { path: '/admin/pegawai', name: 'admin.pegawai', component: page('admin/pegawai/index'), meta: { label: 'Master Pegawai' } },
  { path: '/admin/pegawai/create', name: 'admin.pegawai.create', component: page('admin/pegawai/create'), meta: { label: 'Tambah Pegawai', breadCrumbParent: {name: 'admin.pegawai'} } },
  { path: '/admin/pegawai/:id/edit', name: 'admin.pegawai.edit', component: page('admin/pegawai/edit'), meta: { label: 'Edit Pegawai', breadCrumbParent: {name: 'admin.pegawai'} } },
  { path: '/admin/tim-kerja', name: 'admin.tim-kerja', component: page('admin/tim-kerja/index'), meta: { label: 'Master Tim Kerja / Pengampu Outcome' } },
  { path: '/admin/tim-kerja/create', name: 'admin.tim-kerja.create', component: page('admin/tim-kerja/create'), meta: { label: 'Tambah Tim Kerja / Pengampu Outcome', breadCrumbParent: {name: 'admin.tim-kerja'} } },
  { path: '/admin/tim-kerja/:id/edit', name: 'admin.tim-kerja.edit', component: page('admin/tim-kerja/edit'), meta: { label: 'Edit Tim Kerja / Pengampu Outcome', breadCrumbParent: {name: 'admin.tim-kerja'} } },
