...
const routes = [
  ...
  { path: '/display-makro/rpjmd', name: 'display-makro.rpjmd', component: page('display-makro/rpjmd'), meta: { label: 'RPJMD Provinsi Jawa Barat' } },
  { path: '/display-makro/rkpd', name: 'display-makro.rkpd', component: page('display-makro/rkpd'), meta: { label: 'RKPD Provinsi Jawa Barat' } },
  { path: '/display-makro/perjanjian-kinerja', name: 'display-makro.perjanjian-kinerja', component: page('display-makro/perjanjian-kinerja'), meta: { label: 'Perjanjian Kinerja Gubernur Jawa Barat' } },
  { path: '/display-makro/rencana-aksi', name: 'display-makro.rencana-aksi', component: page('display-makro/rencana-aksi'), meta: { label: 'Rencana Aksi Gubernur Jawa Barat' } },
  ...
  { path: '/public-display/display-makro/rpjmd', name: 'public-display.display-makro.rpjmd', component: page('public-display/display-makro/rpjmd'), meta: { label: 'RPJMD Provinsi Jawa Barat' } },
  { path: '/public-display/display-makro/rkpd', name: 'public-display.display-makro.rkpd', component: page('public-display/display-makro/rkpd'), meta: { label: 'RKPD Provinsi Jawa Barat' } },
  { path: '/public-display/display-makro/perjanjian-kinerja', name: 'public-display.display-makro.perjanjian-kinerja', component: page('public-display/display-makro/perjanjian-kinerja'), meta: { label: 'Perjanjian Kinerja Gubernur Jawa Barat' } },
  { path: '/public-display/display-makro/rencana-aksi', name: 'public-display.display-makro.rencana-aksi', component: page('public-display/display-makro/rencana-aksi'), meta: { label: 'Rencana Aksi Gubernur Jawa Barat' } },
