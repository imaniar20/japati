    ...
    methods: {
        async login() {
            ...
            try {
                const {
                    data: { data },
                } = await await axios.post("/login", this.form);
                ...
                if (this.$store.state.auth.user) {
                    this.$router.replace("/kamus-indikator");
                }
                ...
                const prevUrl = localStorage.getItem(
                    "sakip-redirect-previous-url"
                );
                ...
                if (this.$role.isValidatorBappeda()) {
                    ...
                    this.$router.push(
                        "/sasaran-strategis-pd/validasi-pengampu"
                    );
                } else {
