  ...
  created() {
    ...
    this.form.satuan_kerja_id = this.user.satuan_kerja_id
     if(this.$route.query.id){
      ...
      this.form.sasaran_strategis_pd_id = id
      
      // const sasaranStrategisPd = this.sasaranStrategisPd.find(el => el.id === id);
      // if (sasaranStrategisPd) {
      //   this.form.program_id = kinerjaProgram.program_id; // Assuming kinerjaProgram has a program_id field
      // }
    }
  },
  computed: {
