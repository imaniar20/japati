...
export default {
  ...
  async asyncData({ params }) {
    ...
    const { data: form } = await axios.get(`lkip/narasi-pd/${id}`)
...
<template>
  <b-card>
    ...
    >
      <b-form-input v-model="form.sasaran_strategis_pd" readonly></b-form-input>
    </b-form-group>
    <b-form-group
      label="INDIKATOR PERANGKAT DAERAH"
    >
      <b-form-input v-model="form.iku_pd" readonly></b-form-input>
    </b-form-group>
