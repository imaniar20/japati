...
class CreateSatkerSasaranStrategisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('satker_sasaran_strategis', function (Blueprint $table) {
            ...
            $table->text('sasaran_strategis_satker')->nullable();
            $table->text('iku');
            $table->string('satuan');
    ...
    {
        Schema::dropIfExists('satker_sasaran_strategis');
    }
}
