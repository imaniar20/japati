...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('kinerja_program', function (Blueprint $table) {
            ...
            $table->jsonb('validasi_cascading')->default('{ "status": null, "catatan": null }')->change();

        });

        // reset current value to default
        DB::table('kinerja_program')->update(['validasi_cascading' => '{ "status": null, "catatan": null }']);
    }
