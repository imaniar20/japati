...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('kinerja_sub_kegiatan_kab_kota', function (Blueprint $table) {
            ...
            $table->jsonb('anggaran_bulanan');
            $table->boolean('has_inovasi');
            $table->text('inovasi_uraian')->nullable();
            $table->text('inovasi_tujuan')->nullable();
            $table->jsonb('inovasi_lampiran')->nullable();
            $table->timestamp('created_at')->nullable();
            $table->timestamp('updated_at')->nullable();
            $table->jsonb('realisasi_bulanan')->default('{"apr": null, "aug": null, "dec": null, "feb": null, "jan": null, "jul": null, "jun": null, "mar": null, "may": null, "nov": null, "oct": null, "sep": null}');
            $table->jsonb('realisasi_anggaran_bulanan')->default('{"apr": 0, "aug": 0, "dec": 0, "feb": 0, "jan": 0, "jul": 0, "jun": 0, "mar": 0, "may": 0, "nov": 0, "oct": 0, "sep": 0}');
            ...
            $table->jsonb('validasi_pengampu')->default('{"status": null, "catatan": null}');
