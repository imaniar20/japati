...
class CapaianKinerjaSubKegiatanExport implements FromCollection, WithCustomStartCell, WithEvents, WithHeadings
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('I1', 'Indikator Kinerja');

                $sheet->mergeCells('J1:J2');
                $sheet->setCellValue('J1', 'Target');

                $sheet->mergeCells('K1:V1');
                $sheet->setCellValue('K1', 'Realisasi Bulan Ke');
                $sheet->setCellValue('K2', '1');
                $sheet->setCellValue('L2', '2');
                $sheet->setCellValue('M2', '3');
                $sheet->setCellValue('N2', '4');
                $sheet->setCellValue('O2', '5');
                $sheet->setCellValue('P2', '6');
                $sheet->setCellValue('Q2', '7');
                $sheet->setCellValue('R2', '8');
                $sheet->setCellValue('S2', '9');
                $sheet->setCellValue('T2', '10');
                $sheet->setCellValue('U2', '11');
                $sheet->setCellValue('V2', '12');

                $sheet->mergeCells('W1:W2');
                $sheet->setCellValue('W1', 'Capaian');

                $sheet->mergeCells('X1:Z1');
                $sheet->setCellValue('X1', 'Anggaran');
                $sheet->setCellValue('X2', 'Target (Rp)');
                $sheet->setCellValue('Y2', 'Realisasi (Rp)');
                $sheet->setCellValue('Z2', 'Capaian (%)');
