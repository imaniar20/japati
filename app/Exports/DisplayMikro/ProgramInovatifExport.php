...
class ProgramInovatifExport implements FromCollection, WithCustomStartCell, WithEvents, WithHeadings
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('F1', 'Program/Kegiatan/Langkah Aksi Inovatif');
